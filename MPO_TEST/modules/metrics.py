...
label_set = ['Enlarged' 'Cardiomediastinum','Cardiomegaly','Lung Opacity','Lung Lesion','Edema,Consolidation','Pneumonia',
...
def compute_scores(gts, res):
    ...
    # gen_label = label(chexbert_path, gen_report)  # ���������������chexbert������
    # greedy_label = label(chexbert_path, greedy_report)  # ���������������chexbert������
    # gt_label = label(chexbert_path, gts_report)
    # gen_ce = compute_mlc(gt_label, gen_label)
    # greedy_label = compute_mlc(gt_label, greedy_label)
    eval_res = {}
