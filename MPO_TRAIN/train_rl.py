...
from models.models import PVF_Model
import os
...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/extra/shilei/dataset/physionet.org/files/iu_xray/images/', help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/extra/shilei/dataset/annotations/iu_annotation.json', help='the path to the directory containing the data.')
    ...
    parser.add_argument('--atten_prefer_dim', type=int, default=128, help='.')
    parser.add_argument('--prefer_dim', type=int, default=3, help='.')
    # Trainer settings
    parser.add_argument('--n_gpu', type=int, default=1, help='the number of gpus to be used.')
    parser.add_argument('--epochs', type=int, default=100, help='the number of training epochs.')
    parser.add_argument('--save_dir', type=str, default='result/iu', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default='records_acl/iu_xray/rl', help='the patch to save the results of experiments.')
    ...
    parser.add_argument('--index_period', type=int, default=200, help='the period of cxr.')
    ...
    parser.add_argument('--noamopt_warmup', type=int, default=7770, help='.')
    parser.add_argument('--noamopt_factor', type=int, default=1, help='.')
    parser.add_argument('--r', type=int, default=1, help='LoRA的低秩矩阵的秩数')
    parser.add_argument('--index', type=int, default=0, help='the index of prefer_vector')
...
def main():
    ...
    model = PVF_Model(args, tokenizer)
    ...
    trainer = Trainer(model, criterion, metrics, ve_optimizer, ed_optimizer, args, tokenizer, train_dataloader, val_dataloader, test_dataloader)
    trainer.train()
