...
--batch_size 6 \
--epochs 280 \
--save_dir /home/shilei/project/R2GenRL/result/mimic_cxr/7580/B1_B4_F1 \
--record_dir /home/shilei/project/R2GenRL/result/mimic_cxr/7580/B1_B4_F1/reports \
--step_size 1 \
--gamma 0.8 \
--seed 7580 \
--topk 32 \
